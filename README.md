...
Nest is a lightweight, in-memory database with persistent storage capabilities designed specifically for Flutter applications. It provides a simple yet powerful way to manage structured data within your app, offering features like schema validation, reactive updates, and persistent storage.
...
- Add `nest` to your `pubspec.yaml` dependencies:
...
print(user?.data); // Output: {id: 1, name: Alice, age: 30, email: alice@example.com, createdAt: ..., updatedAt: ...}
```
